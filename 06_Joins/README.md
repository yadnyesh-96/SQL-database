...
- What is the joins & why use it ? 
  ---
  - Join is the part of select query normally which is used for fetch data from two or more than two table those are interconnected with each other called as joins.
  - Noramlly joins fetch data from different table from database and show as single table output to end user.
  - **Types of joins**
  - 1. `Inner join`
  - 2. `Left join`
  - 3. `Right join`

...
--table -2
create table employee(empId INT(5)PRIMARY KEY AUTO_INCREMENT,empName VARCHAR(200)NOT NULL,email VARCHAR(200)NOT NULL UNIQUE,contact VARCHAR(200)NOT NULL UNIQUE,deptId INT(5),FOREIGN KEY(deptId));
```
